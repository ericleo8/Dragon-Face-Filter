...
class FaceMesh():
    ...
    def isOpen(self, image, face_mesh_results, face_part, threshold=5):
        ...
        if face_part == 'MOUTH':
            ...
            # Call the method to detect facial area in the mouth region
            # Example: mouth_results = self.mpFaceMesh.detectMouth(face_mesh_results)
        elif face_part == 'LEFT EYE':
            INDEXES = self.mpFaceMesh.FACEMESH_LEFT_EYE
            # Call the method to detect facial area in the left eye region
            # Example: left_eye_results = self.mpFaceMesh.detectLeftEye(face_mesh_results)
        elif face_part == 'RIGHT EYE':
            INDEXES = self.mpFaceMesh.FACEMESH_RIGHT_EYE
            # Call the method to detect facial area in the right eye region
            # Example: right_eye_results = self.mpFaceMesh.detectRightEye(face_mesh_results)
        else:
            return
